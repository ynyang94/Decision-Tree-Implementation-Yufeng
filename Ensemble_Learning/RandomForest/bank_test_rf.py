...
for t in range(T):
    ...
    dt_generator = RF.ID3(metric_selection='entropy', max_depth= depth, attribute_subset=subset_size )
...
fig.suptitle('training and test error for random forest methods')
